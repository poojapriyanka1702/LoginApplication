    ...
    : QMainWindow(parent)
{
    ...
    l->move(100,50);
    QPixmap p("F:/ayyanar/C++/simpleloginform/login.png");
    l->setPixmap(p.scaled(20,20));

    QLabel *lb=new QLabel(this);
    lb->move(180,25);
    lb->setAlignment(Qt::AlignHCenter);
    QPixmap pi("F:/ayyanar/C++/simpleloginform/username.png");
    ...
    QPixmap pix("F:/ayyanar/C++/simpleloginform/password.png");
    ...
    connect(btn,&QPushButton::clicked,[=](){
        ...
        QString p=lie->text();
        if(uname=="priyanka"&& p=="212218108042")
        {
